...
public class ParcelsController {
    ...
    public String find(
        ...
        return loadingParcelsService.send("find", Map.of(
    ...
    public String create(
        ...
        return loadingParcelsService.send("create", Map.of(
    ...
    public String update(
        ...
        return loadingParcelsService.send("update", Map.of(
    ...
    public String delete(@ShellOption(help = "Название посылки") String name) {
        return loadingParcelsService.send("delete", Map.of(
    ...
    public String load(
        ...
        return loadingParcelsService.send("load", Map.of(
    ...
    public String unload(
        ...
        return loadingParcelsService.send("unload", Map.of(
