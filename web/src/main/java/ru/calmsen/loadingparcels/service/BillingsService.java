...
public class BillingsService {
    ...
    public void addLoadParcelsBilling(String user, List<Truck> trucks){
        ...
        var message = createOutboxMessage(user, trucks, "loadParcelsBilling");
    ...
    public void addUnloadParcelsBilling(String user, List<Truck> trucks){
        ...
        var message = createOutboxMessage(user, trucks, "unloadParcelsBilling");
        outboxRepository.save(message);
    }

    private OutboxMessage createOutboxMessage(String user, List<Truck> trucks, String messageType) {
