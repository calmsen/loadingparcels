...
class JsonParcelsViewTest {
    @Test
    void buildOutputData_emptyParcels_returnsEmptyArrayInJson() {
        // Arrange
        var view = new JsonParcelsView(new ParcelsMapperImpl());
    ...
    void buildOutputData_oneParcel_returnsParcelInfoInJson() {
        ...
        // Assert
        assertThat(result).isEqualTo("[{\"width\":3,\"height\":3,\"form\":\"xxx\\nxxx\\nxxx\",\"dimensions\":9,\"symbol\":\"9\",\"name\":\"Посылка тип 9\"}]");
    }
